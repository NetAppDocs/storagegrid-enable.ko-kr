...
+
image:third-party-new-partition-3.png["타사 - 신규 - 파티션 - 3"]



. StorageGRID 버킷에 대한 연결을 확인하려면 테스트 를 클릭합니다. 연결 테스트가 성공했는지 확인합니다. 확인을 클릭한 후 다음을 클릭합니다.
+
image:third-party-new-partition-4.png["타사 - 신규 - 파티션 - 4"]
...
+
image:third-party-new-partition-5.png["타사 - 새 - 파티션 - 5"]

. 요약 페이지에서 정보를 확인하고 마침 을 클릭합니다.
+
image:third-party-new-partition-6.png["타사 - 신규 - 파티션 - 6"]

. 새 볼트 저장소 파티션이 생성되면 StorageGRID를 기본 저장소로 사용하여 Enterprise Vault에서 데이터를 보관, 복원 및 검색할 수 있습니다.
+
image:third-party-new-partition-7.png["타사 - 신규 - 파티션 - 7"]
