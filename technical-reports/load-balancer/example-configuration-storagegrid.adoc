...
+
image:load-balancer-monitor-configuration-page.png["모니터 구성 페이지"]
...
image:load-balancer-citrix-netscaler-configuration-page.png["Citrix NetScaler Monitor 구성 페이지"]
