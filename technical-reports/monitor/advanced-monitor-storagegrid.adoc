...
image:monitor-metrics-page.png["monitor-metrics-page 를 참조하십시오"]

또는 링크로 직접 이동할 수 있습니다.

image:monitor-prometheus-interface.png["monitor-Prometheus-interface 를 참조하십시오"]
...
+
image:monitor-http-sessions.png["monitor-http-sessions 를 참조하십시오"]
...
+
image:monitor-metrics-query.png["monitor-metrics-query 를 참조하십시오"]
...
+
image:monitor-sample-prometheus-query-responses.png["monitor-sample-Prometheus-query-responses 를 참조하십시오"]
