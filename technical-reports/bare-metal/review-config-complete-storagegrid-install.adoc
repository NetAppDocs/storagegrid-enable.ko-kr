...
. 요약 페이지를 봅니다.
+
image:bare-metal-summary-page.png["베어 메탈 요약 페이지입니다"]
...
+
image:bare-metal-download-recovery-package.png["Bare Metal-download-recovery-package 를 참조하십시오"]

+
설치가 여전히 진행 중인 경우 설치 상태 페이지가 열립니다. 이 페이지에는 각 그리드 노드의 설치 진행률이 표시됩니다.

+
image:bare-metal-installation-status.png["베어 메탈 설치 상태입니다"]
