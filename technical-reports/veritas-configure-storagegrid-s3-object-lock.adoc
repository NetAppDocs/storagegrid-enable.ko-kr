...
.단계
. 해당 link:veritas-configure-storagegrid-s3-object-lock.html#configure-storagegrid-s3-object-lock-default-bucket-retention["기본 구성"] 섹션의 1~3단계를 반복하되, 이번에는 Store data in WORM Mode Using S3 Object Lock 옵션을 선택합니다. 다음을 클릭합니다.
+
