...
[[keep-5-noncurrent-versions-and-delete-after-90-days]]
=== 최신 버전이 아닌 5개 버전을 보관하고 90일 후에 삭제
...
NOTE: *NoncurrentDays*와 *NewerNoncurrentVersions*를 함께 사용해야 합니다.
...
[[remove-delete-markers-that-have-no-other-versions-retain-4-non-current-versions-and-at-least-30-days-worth-of-history-for-objects-with-the-accounts-prefix-and-keep-2-versions-and-at-least-10-days-worth-of-history-for-all-other-object-versions]]
=== 다른 버전이 없는 삭제 마커를 제거하고, "accounts_ prefix"가 있는 개체의 경우 4개의 비현재 버전과 최소 30일 분의 기록을 유지하고, 다른 모든 개체 버전의 경우 2개의 버전과 최소 10일 분의 기록을 유지합니다.
